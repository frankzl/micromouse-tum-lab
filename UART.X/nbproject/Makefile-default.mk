...
SOURCEFILES_QUOTED_IF_SPACED=gpIO.c main.c pwm1Functions.c timer1Functions.c uart1Functions.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/gpIO.o ${OBJECTDIR}/main.o ${OBJECTDIR}/pwm1Functions.o ${OBJECTDIR}/timer1Functions.o ${OBJECTDIR}/uart1Functions.o
POSSIBLE_DEPFILES=${OBJECTDIR}/gpIO.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/pwm1Functions.o.d ${OBJECTDIR}/timer1Functions.o.d ${OBJECTDIR}/uart1Functions.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/gpIO.o ${OBJECTDIR}/main.o ${OBJECTDIR}/pwm1Functions.o ${OBJECTDIR}/timer1Functions.o ${OBJECTDIR}/uart1Functions.o

# Source Files
SOURCEFILES=gpIO.c main.c pwm1Functions.c timer1Functions.c uart1Functions.c
...
${OBJECTDIR}/gpIO.o: gpIO.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/gpIO.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  gpIO.c  -o ${OBJECTDIR}/gpIO.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/gpIO.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/uart1Functions.o: uart1Functions.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/uart1Functions.o.d 
	@${RM} ${OBJECTDIR}/uart1Functions.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  uart1Functions.c  -o ${OBJECTDIR}/uart1Functions.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/uart1Functions.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/uart1Functions.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/uart1Functions.o: uart1Functions.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/uart1Functions.o.d 
	@${RM} ${OBJECTDIR}/uart1Functions.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  uart1Functions.c  -o ${OBJECTDIR}/uart1Functions.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/uart1Functions.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/uart1Functions.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
